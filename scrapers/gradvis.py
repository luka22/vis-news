...
API_URL = "https://www.gradvis.hr/wp-json/wp/v2/posts?per_page=20&_fields=id,title,link,date,excerpt"


class GradVisScraper(BaseScraper):
    source = "gradvis.hr"
